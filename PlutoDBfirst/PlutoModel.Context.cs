...
namespace PlutoDBfirst
{
    ...
    public partial class PlutoContextEntities : DbContext
    {
        public PlutoContextEntities()
            : base("name=PlutoContextEntities")
        {
        }
        ...
        [DbFunction("PlutoContextEntities", "GetAuthorCourses")]
        public virtual IQueryable<funcGetAuthorCourses_Result> GetAuthorCourses(Nullable<int> authorID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<funcGetAuthorCourses_Result>("[PlutoContextEntities].[GetAuthorCourses](@AuthorID)", authorIDParameter);
        }
